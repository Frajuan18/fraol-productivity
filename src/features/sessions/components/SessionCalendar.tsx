                ...
                >
                  ...
                  {hasSession && (
                    <div className="flex items-center gap-0.5 mt-0.5">
                      ...
                      {sessionCount > 1 && (
                        <span
                          className={`text-[8px] ${isSelectedDate ? 'text-text-secondary' : 'text-text-secondary'}`}
                        >
                          +{sessionCount - 1}
                        </span>
                      )}
                  ...
                  {allCompleted && (
                    <div
                      className={`absolute -top-0.5 -right-0.5 ${isSelectedDate ? 'text-accent-contrast' : 'text-success'}`}
                    >
